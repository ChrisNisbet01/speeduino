  ...
  const uint16_t angle[])
{
  ...
  assert_fuel_channel(enabled[0], angle[0], INJ1_CMD_BIT, injector_contexts[injChannel1].channelInjDegrees, fuelSchedules[injChannel1].start.pCallback, fuelSchedules[injChannel1].end.pCallback);
  assert_fuel_channel(enabled[1], angle[1], INJ2_CMD_BIT, injector_contexts[injChannel2].channelInjDegrees, fuelSchedules[injChannel2].start.pCallback, fuelSchedules[injChannel2].end.pCallback);
  assert_fuel_channel(enabled[2], angle[2], INJ3_CMD_BIT, injector_contexts[injChannel3].channelInjDegrees, fuelSchedules[injChannel3].start.pCallback, fuelSchedules[injChannel3].end.pCallback);
  assert_fuel_channel(enabled[3], angle[3], INJ4_CMD_BIT, injector_contexts[injChannel4].channelInjDegrees, fuelSchedules[injChannel4].start.pCallback, fuelSchedules[injChannel4].end.pCallback);

#if INJ_CHANNELS>=5
  assert_fuel_channel(enabled[4], angle[4], INJ5_CMD_BIT, injector_contexts[injChannel5].channelInjDegrees, fuelSchedules[injChannel5].start.pCallback, fuelSchedules[injChannel5].end.pCallback);
#endif

#if INJ_CHANNELS>=6
  assert_fuel_channel(enabled[5], angle[5], INJ6_CMD_BIT, injector_contexts[injChannel6].channelInjDegrees, fuelSchedules[injChannel6].start.pCallback, fuelSchedules[injChannel6].end.pCallback);
#endif

#if INJ_CHANNELS>=7
  assert_fuel_channel(enabled[6], angle[6], INJ7_CMD_BIT, injector_contexts[injChannel7].channelInjDegrees, fuelSchedules[injChannel7].start.pCallback, fuelSchedules[injChannel7].end.pCallback);
#endif

#if INJ_CHANNELS>=8
  assert_fuel_channel(enabled[7], angle[7], INJ8_CMD_BIT, injector_contexts[injChannel8].channelInjDegrees, fuelSchedules[injChannel8].start.pCallback, fuelSchedules[injChannel8].end.pCallback);
#endif
}
