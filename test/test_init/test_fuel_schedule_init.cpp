  ...
  const uint16_t angle[])
{
  ...
  assert_fuel_channel(enabled[0], angle[0], INJ1_CMD_BIT, injectors_context.injectors[injChannel1].channelInjDegrees, fuelSchedule1.pStartFunction, fuelSchedule1.pEndFunction);
  assert_fuel_channel(enabled[1], angle[1], INJ2_CMD_BIT, injectors_context.injectors[injChannel2].channelInjDegrees, fuelSchedule2.pStartFunction, fuelSchedule2.pEndFunction);
  assert_fuel_channel(enabled[2], angle[2], INJ3_CMD_BIT, injectors_context.injectors[injChannel3].channelInjDegrees, fuelSchedule3.pStartFunction, fuelSchedule3.pEndFunction);
  assert_fuel_channel(enabled[3], angle[3], INJ4_CMD_BIT, injectors_context.injectors[injChannel4].channelInjDegrees, fuelSchedule4.pStartFunction, fuelSchedule4.pEndFunction);

#if INJ_CHANNELS>=5
  assert_fuel_channel(enabled[4], angle[4], INJ5_CMD_BIT, injectors_context.injectors[injChannel5].channelInjDegrees, fuelSchedule5.pStartFunction, fuelSchedule5.pEndFunction);
#endif

#if INJ_CHANNELS>=6
  assert_fuel_channel(enabled[5], angle[5], INJ6_CMD_BIT, injectors_context.injectors[injChannel6].channelInjDegrees, fuelSchedule6.pStartFunction, fuelSchedule6.pEndFunction);
#endif

#if INJ_CHANNELS>=7
  assert_fuel_channel(enabled[6], angle[6], INJ7_CMD_BIT, injectors_context.injectors[injChannel7].channelInjDegrees, fuelSchedule7.pStartFunction, fuelSchedule7.pEndFunction);
#endif

#if INJ_CHANNELS>=8
  assert_fuel_channel(enabled[7], angle[7], INJ8_CMD_BIT, injectors_context.injectors[injChannel8].channelInjDegrees, fuelSchedule8.pStartFunction, fuelSchedule8.pEndFunction);
#endif
}
