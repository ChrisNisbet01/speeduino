...
void test_ngc_newIgn_12_trig0_1()
{
    ...
    ignitions.ignition(ignChannel1).calculateIgnitionAngle(5, 0, 10);
    triggerSetEndTeeth_NGC();
    TEST_ASSERT_EQUAL(34, ignition1EndTooth);

    //Test again with 0 degrees advance
    ignitions.ignition(ignChannel1).calculateIgnitionAngle(5, 0, 0);
    triggerSetEndTeeth_NGC();
    TEST_ASSERT_EQUAL(34, ignition1EndTooth);

    //Test again with 35 degrees advance
    ignitions.ignition(ignChannel1).calculateIgnitionAngle(5, 0, 35);
    triggerSetEndTeeth_NGC();
