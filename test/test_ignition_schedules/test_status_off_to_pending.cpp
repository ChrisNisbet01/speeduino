...
static void test_status_off_to_pending_ign(IgnitionSchedule &ignitionSchedule)
{
...
{
  test_status_off_to_pending_ign(ignitionSchedules[ignChannel1]);
}

static void test_status_off_to_pending_ign2(void)
{
  test_status_off_to_pending_ign(ignitionSchedules[ignChannel2]);
}

static void test_status_off_to_pending_ign3(void)
{
  test_status_off_to_pending_ign(ignitionSchedules[ignChannel3]);
}

static void test_status_off_to_pending_ign4(void)
{
  test_status_off_to_pending_ign(ignitionSchedules[ignChannel4]);
}

#if IGN_CHANNELS >= 5
static void test_status_off_to_pending_ign5(void)
{
  test_status_off_to_pending_ign(ignitionSchedules[ignChannel5]);
}
#endif
...
{
  test_status_off_to_pending_ign(ignitionSchedules[ignChannel6]);
}
#endif
...
{
  test_status_off_to_pending_ign(ignitionSchedules[ignChannel7]);
}
#endif
...
{
  test_status_off_to_pending_ign(ignitionSchedules[ignChannel8]);
}
#endif
