...
static byte to_byte_2(int16_t value) //cppcheck-suppress misra-c2012-10.8
{
  return value / 2;
}
...
{
  return domain == axis_domain_Rpm
         ? table3d_axis_io_converter{&to_byte_100, &from_byte_100}
         : domain == axis_domain_Load
           ? table3d_axis_io_converter{&to_byte_2, &from_byte_2}
