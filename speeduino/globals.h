...
//The below shouldn't be needed and probably should be cleaned up,
//but the Atmel SAM (ARM) boards use a specific type for the trigger edge values rather than a simple byte/int
#if defined(CORE_SAMD21)
typedef PinStatus trigger_edge_t;
#else
typedef byte trigger_edge_t;
#endif
extern trigger_edge_t primaryTriggerEdge;
extern trigger_edge_t secondaryTriggerEdge;
extern trigger_edge_t tertiaryTriggerEdge;
